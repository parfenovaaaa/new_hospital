...
class TestPatientsStatusListHandler:
    ...
    def test_check_possibility_of_patient_status_down_success(self):
        patients_list = PatientsStatusListHandler([2])
    ...
    def test_check_possibility_of_patient_status_up_true(self):
        patients_list = PatientsStatusListHandler([2])
